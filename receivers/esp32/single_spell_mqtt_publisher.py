...
MQTT_TOPIC = "mythichome/events/cast"
SENSOR_ID = "picture_node"             # Identifier for this receiver location
...
class SimpleMQTTClient:
    ...
    def connect(self):
        ...
        # print(f"As user {self.user} and password {self.password}")
...
print("==================================================")
print("🪄  MagiQuest Wi-Fi MQTT Sensor Active!")
print("==================================================")
    ...
    if ir_pin.value() == 0:
        ...
        if len(marks) >= 48:
            ...
            if valid and len(bits) == 48:
                ...
                if mqtt_connected:
                    success = mqtt.publish(MQTT_TOPIC, json_payload)
                    if success:
